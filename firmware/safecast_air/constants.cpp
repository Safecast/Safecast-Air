...
namespace constants
{
    ...
    {   // gasType, serialNumber, header, position, workingAinPin, auxillaryAinPin, workingZero, auxillaryZero,
        ...
        {GAS_TYPE_NO2, 161740024ul, 0, 0, A0,  A1,  0.234,  0.235,  0.435,  1.2,  4.4,  1.00,  0.005,  3, true}, 
        {GAS_TYPE_O3,  165417321ul, 0, 1, A2,  A3,  0.416,  0.416,  0.321,  1.2,  4.4,  1.00,  0.005,  3, true},
        {GAS_TYPE_CO,  162740011ul, 0, 2, A4,  A5,  0.398,  0.346,  0.403,  1.2,  4.4,  1.00,  0.005,  3, true},
        {GAS_TYPE_NO2, 161740022ul, 1, 0, A6,  A7,  0.226,  0.226,  0.374,  1.2,  4.4,  1.00,  0.005,  3, true},
        {GAS_TYPE_O3,  165417320ul, 1, 1, A8,  A9,  0.405,  0.417,  0.283,  1.2,  4.4,  1.00,  0.005,  3, true},
        {GAS_TYPE_CO,  162740010ul, 1, 2, A10, A11, 0.406,  0.363,  0.381,  1.2,  4.4,  1.00,  0.005,  3, true}
    };
